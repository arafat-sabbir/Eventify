    ...
    return (
        <div className=" bg-gray-800 text-neutral-content">
            <footer className="footer p-10 container mx-auto  place-items-center ">
                <Link to={'/'}>
                    <aside>
                        <img src={logo} className="w-32 h-28" alt="" />
                        <p className="font-medium" > <span className="text-2xl text-success font-bold">Eventify</span>  Industries Ltd.<br />Providing reliable Event since 1999</p>
                    </aside>
                </Link>

                <nav>
                    <header className="mb-2 font-bold text-xl">Find Us on</header>
